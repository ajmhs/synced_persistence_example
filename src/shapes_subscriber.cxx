    ...
    unsigned int sample_count)
{
    ...
    dds::sub::DataReader< ::ShapeTypeExtended> reader(subscriber, topic, qos_provider.datareader_qos());
...
int main(int argc, char *argv[])
{
    ...
    try {
        run_subscriber_application(arguments.domain_id, arguments.qos_file, arguments.sample_count);
